...
export class ExcelSource implements HRSource {
  public readonly sourceName: string = 'excel';
  ...
  public normalizeRows(rawRows: Record<string, any>[]): RawWorkerData[] {
...
// Backward compatibility alias as requested in specification
export class CSVSource extends ExcelSource {
  public override readonly sourceName = 'csv';
}
