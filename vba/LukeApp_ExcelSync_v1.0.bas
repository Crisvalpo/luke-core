...
Public Sub IrALineasRibbon(control As IRibbonControl)
    NavegarOCrearHoja "LIST_LINEAS", "tbl_lineas", "UUID,LINE_TAG,SERVICE_CODE,NOMINAL_SIZE,PIPING_CLASS,MATERIAL_BASE,PID_REFERENCE,SISTEMA,SUB_SISTEMA,ORIGIN_POINT,DESTINATION_POINT,ROUTE_DESCRIPTION,TOTAL_LENGTH,DESIGN_PRESSURE,DESIGN_TEMP,TEST_PRESSURE,PAINTING_SPEC,INTERNAL_LINING,INSULATION_SPEC,TRACING_SPEC,NDT_LEVEL,PWHT_REQUIRED,CWA,CWP,LINE_STATUS,DATA_SOURCE,FECHA_CREACION,CREADO_POR,FECHA_EDICION,EDITADO_POR"
End Sub

Public Sub IrAIsometricosRibbon(control As IRibbonControl)
    NavegarOCrearHoja "LIST_ISOMETRICOS", "tbl_isometricos", "UUID,ISO_TAG,LINE_TAG,SHEET_NO,LINE_SEGMENT,CLIENT_DRAWING_NO,CONTRACTOR_DRAWING_NO,ENGINEERING_COMPANY,CONDITION,SPOOLING_STATUS,TEST_PACK_ID,CWA,CWP,CURRENT_REVISION,DOCUMENT_URL,ISO_STATUS,REMARKS,FECHA_CREACION,CREADO_POR,FECHA_EDICION,EDITADO_POR"
End Sub
...
Public Sub ActualizarHojaActiva()
    ...
    Select Case nombreHoja
        ...
        Case "LIST_LINEAS"
            ...
            totalProcesados = DescargarYFusionarLista("/api/piping/lineas", "LIST_LINEAS", "tbl_lineas", "UUID,LINE_TAG,SERVICE_CODE,NOMINAL_SIZE,PIPING_CLASS,MATERIAL_BASE,PID_REFERENCE,SISTEMA,SUB_SISTEMA,ORIGIN_POINT,DESTINATION_POINT,ROUTE_DESCRIPTION,TOTAL_LENGTH,DESIGN_PRESSURE,DESIGN_TEMP,TEST_PRESSURE,PAINTING_SPEC,INTERNAL_LINING,INSULATION_SPEC,TRACING_SPEC,NDT_LEVEL,PWHT_REQUIRED,CWA,CWP,LINE_STATUS,DATA_SOURCE,FECHA_CREACION,CREADO_POR,FECHA_EDICION,EDITADO_POR", "line_tag", idProyecto)
        ...
        Case "LIST_ISOMETRICOS"
            ...
            totalProcesados = DescargarYFusionarLista("/api/piping/isometricos", "LIST_ISOMETRICOS", "tbl_isometricos", "UUID,ISO_TAG,LINE_TAG,SHEET_NO,LINE_SEGMENT,CLIENT_DRAWING_NO,CONTRACTOR_DRAWING_NO,ENGINEERING_COMPANY,CONDITION,SPOOLING_STATUS,TEST_PACK_ID,CWA,CWP,CURRENT_REVISION,DOCUMENT_URL,ISO_STATUS,REMARKS,FECHA_CREACION,CREADO_POR,FECHA_EDICION,EDITADO_POR", "iso_tag", idProyecto)
