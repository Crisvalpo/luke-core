...
Public Sub IrAJuntasRibbon(control As IRibbonControl)
    NavegarOCrearHoja "LIST_JUNTAS", "tbl_juntas", "UUID,ID_JUNTA,CODIGO_SPOOL,CODIGO_ISO,TAG,TIPO_UNION,DESTINATION,NPS,SCH,CLASE,MATERIAL,METROS,SERVICIO,ESTADO,OBSERVACIONES,FECHA_CREACION,CREADO_POR,FECHA_SYNC,EDITADO_POR"
End Sub
...
Private Function SincronizarJuntasDesdeNube(ByVal idProyecto As String) As Long
    SincronizarJuntasDesdeNube = DescargarYFusionarLista( _
        ...
        "LIST_JUNTAS", _
        "tbl_juntas", _
        "UUID,ID_JUNTA,CODIGO_SPOOL,CODIGO_ISO,TAG,TIPO_UNION,DESTINATION,NPS,SCH,CLASE,MATERIAL,METROS,SERVICIO,ESTADO,OBSERVACIONES,FECHA_CREACION,CREADO_POR,FECHA_SYNC,EDITADO_POR", _
        "id_junta", _
        idProyecto)
End Function
