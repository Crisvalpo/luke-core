...
Public Sub IrAIsometricosRibbon(control As IRibbonControl)
    NavegarOCrearHoja "LIST_ISOMETRICOS", "tbl_isometricos", "UUID,ISO_TAG,LINE_TAG,SHEET_NO,LINE_SEGMENT,CLIENT_DRAWING_NO,CONTRACTOR_DRAWING_NO,ENGINEERING_COMPANY,CONDITION,SPOOLING_STATUS,TEST_PACK_ID,CURRENT_REVISION,DOCUMENT_URL,ISO_STATUS,REMARKS,FECHA_CREACION,CREADO_POR,FECHA_EDICION,EDITADO_POR"
End Sub

Public Sub IrASpoolsRibbon(control As IRibbonControl)
    NavegarOCrearHoja "LIST_SPOOLS", "tbl_spools", "UUID,SPOOL_TAG,ISO_TAG,SPOOL_NO,CWA,CWP,IWP,SPOOL_TYPE,TOTAL_WEIGHT_KG,TOTAL_LENGTH_M,CURRENT_LOCATION,CURRENT_STAGE,SPOOL_STATUS,REMARKS,FECHA_CREACION,CREADO_POR,FECHA_EDICION,EDITADO_POR"
End Sub
...
Public Sub IrAMTORibbon(control As IRibbonControl)
    NavegarOCrearHoja "LIST_MTO", "tbl_mto", "UUID,MTO_TAG,SPOOL_TAG,ISO_TAG,LINE_TAG,ITEM_NO,MATERIAL_GROUP,DESCRIPTION,NOMINAL_SIZE,RATING_SCHEDULE,MATERIAL_SPEC,QUANTITY,UNIT,WEIGHT_KG,SUPPLY_SCOPE,PURCHASE_ORDER_NO,HEAT_NUMBER,WAREHOUSE_LOCATION,MATERIAL_STATUS,REMARKS,FECHA_CREACION,CREADO_POR,FECHA_EDICION,EDITADO_POR"
End Sub
...
Public Sub PublicarHojaActiva()
    ...
    Select Case nombreHoja
        ...
        Case "LIST_LINEAS"
            PublicarTablaGenerica "/api/piping/lineas", "LIST_LINEAS", "tbl_lineas", "LINE_TAG"
        Case "LIST_ISOMETRICOS"
            PublicarTablaGenerica "/api/piping/isometricos", "LIST_ISOMETRICOS", "tbl_isometricos", "ISO_TAG"
        Case "LIST_SPOOLS"
            PublicarTablaGenerica "/api/piping/spools", "LIST_SPOOLS", "tbl_spools", "SPOOL_TAG"
        Case "LIST_JUNTAS"
        ...
        Case "LIST_MTO"
            PublicarTablaGenerica "/api/piping/mto", "LIST_MTO", "tbl_mto", "MTO_TAG"
...
Public Sub ActualizarHojaActiva()
    ...
    Select Case nombreHoja
        ...
        Case "LIST_ISOMETRICOS"
            ...
            totalProcesados = DescargarYFusionarLista("/api/piping/isometricos", "LIST_ISOMETRICOS", "tbl_isometricos", "UUID,ISO_TAG,LINE_TAG,SHEET_NO,LINE_SEGMENT,CLIENT_DRAWING_NO,CONTRACTOR_DRAWING_NO,ENGINEERING_COMPANY,CONDITION,SPOOLING_STATUS,TEST_PACK_ID,CURRENT_REVISION,DOCUMENT_URL,ISO_STATUS,REMARKS,FECHA_CREACION,CREADO_POR,FECHA_EDICION,EDITADO_POR", "iso_tag", idProyecto)
        ...
        Case "LIST_SPOOLS"
            ...
            totalProcesados = DescargarYFusionarLista("/api/piping/spools", "LIST_SPOOLS", "tbl_spools", "UUID,SPOOL_TAG,ISO_TAG,SPOOL_NO,CWA,CWP,IWP,SPOOL_TYPE,TOTAL_WEIGHT_KG,TOTAL_LENGTH_M,CURRENT_LOCATION,CURRENT_STAGE,SPOOL_STATUS,REMARKS,FECHA_CREACION,CREADO_POR,FECHA_EDICION,EDITADO_POR", "spool_tag", idProyecto)
        ...
        Case "LIST_MTO"
            ...
            totalProcesados = DescargarYFusionarLista("/api/piping/mto", "LIST_MTO", "tbl_mto", "UUID,MTO_TAG,SPOOL_TAG,ISO_TAG,LINE_TAG,ITEM_NO,MATERIAL_GROUP,DESCRIPTION,NOMINAL_SIZE,RATING_SCHEDULE,MATERIAL_SPEC,QUANTITY,UNIT,WEIGHT_KG,SUPPLY_SCOPE,PURCHASE_ORDER_NO,HEAT_NUMBER,WAREHOUSE_LOCATION,MATERIAL_STATUS,REMARKS,FECHA_CREACION,CREADO_POR,FECHA_EDICION,EDITADO_POR", "mto_tag", idProyecto)
